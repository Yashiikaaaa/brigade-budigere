...
import image from '../assets/amenities/1545117602_Brigade_Buena_Vista_Phase_2_Elevation_Image_1.jpeg';
  ...
  return (
    <div className="bg-PrestigeGrey">
      ...
      >
        ...
        Luxury Living by Brigade on Budigere Road </span>
          <br />
          
            <span>
            <p>Brigade Group unveils an upcoming luxury residential project on Budigere Main Road, East Bangalore, offering excellent connectivity to Whitefield, the Airport, and key IT hubs—ideal for end-use and investment.</p>
            <br/>
            <p> Set across 10.75 acres with G+43 towers, the project features thoughtfully designed 1, 2 & 3 BHK residences, backed by Brigade’s trusted legacy and strong long-term appreciation potential. </p>
